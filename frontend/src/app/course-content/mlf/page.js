...
const CourseContentPage = ({ courseName }) => {
  ...
  const practiceAssignment = {
    ...
    questions: [
      {
        question: "Approximate the value of e 0.011 by linearizing e x around x=0.",
        options: ["1.011", "1.11", "2.11", "1.5"],
        correctAnswer: 0,
      },
      {
        question: "Regression and classification are two types of supervised machine learning techniques while clustering and density estimation are two types of unsupervised learning. True or False?",
        options: ["True", "False"],
        correctAnswer: 0,
      },
    ],
  ...
  const gradedAssignment = {
    ...
    questions: [
      {
        question: "The linear approximation of tan(x) around  x = 0 is?",
        options: ["1 + x", "1 - x", "x - 1", "x"],
        correctAnswer: 2,
      },
      {
        question: "What is the gradient of f(x,y)=x  2  y at (1, 3)?",
        options: ["[1,6]", "[6,1]", "[1,3]", "[3,1]"],
        correctAnswer: 2,
      },
    ],
  };
